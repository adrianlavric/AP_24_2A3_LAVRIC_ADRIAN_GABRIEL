...
public class BookRepository extends AbstractRepository<Book, Long> {
    ...
    public List<Book> findByAuthor(Author author) {
        ...
        List<Book> books = entityManager.createQuery(
                        "SELECT b FROM Book b JOIN b.bookAuthors ba WHERE ba.author.id = :authorId", Book.class)
    ...
    public boolean isBookAssociatedWithAuthor(Long bookId, Long authorId) {
        ...
        Long count = entityManager.createQuery(
                ...
                .getSingleResult();
        long executionTime = System.currentTimeMillis() - startTime;
        logger.info("JPQL (Is book associated with author) query executed in " + executionTime + " ms");
        return count > 0;
    }
